        ...
        <div class="detail-sidebar">
            <div class="detail-sidebar-wrapper">
                <div class="form-group">
                    ...
                    <div class="form-group-body">
                        <x-form.list-check one-value="true" style="list" default="Chọn phân quyền cha" selected="{{old('parent_id')}}" id="parent_id" name="parent_id" values="{{json_encode($listPermission)}}"/>
                    </div>
                </div>
                <div class="form-group">
